...
//class ResourceLoaderDelegate2: NSObject, AVAssetResourceLoaderDelegate, URLSessionDelegate, URLSessionDataDelegate {
...
//// MARK: - ContentView
//struct d: View {
//    let videoURL = URL(string: "https://example.com/your-video-file.m3u8")!
//
//    var body: some View {

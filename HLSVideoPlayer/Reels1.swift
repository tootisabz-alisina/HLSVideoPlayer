...
//                                                    }
//                                                    // Seek the new video to the start and play it
//                                                    print("Seeking video \(index) to start and playing")
//                                                    player.seek(to: .zero) // Restart from the beginning
//                                                    player.play()
//                                                    currentIndex = index
//                                                }
//                                            }
...
//                                            if index == 0 {
//                                                players[index]?.seek(to: .zero) // Start from the beginning
//                                                players[index]?.play()
//                                                currentIndex = 0
//                                            }
//                                        }
...
/*
 THIS REEL PLAYER HAS SOME PRELOAD ISSUES
 */
